...
<head>
    ...
    <title>Deleted Users - <?php appName($dbh); ?></title>
    ...
    <div id="wrapper">
        <?php include('../includes/leftbar.php');?>
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Deleted Users List</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Deleted Users</p>
                        </div>
...
$results_per_page = 50; 
    ...
    $sql01 = "SELECT * FROM deleteduser order by id ASC";
...
$sql = "SELECT * from  deleteduser order by id ASC LIMIT ".$page_first_result.",".$results_per_page;
$query = $dbh -> prepare($sql);
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label class="form-label"><?php echo "Total Deleted Users: ".$number_of_result?></label></div>
                                </div>
                                <div class="col-md-6">
