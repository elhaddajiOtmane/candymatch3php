...
<head>
    ...
    <title>Feedback List - <?php appName($dbh); ?></title>
    ...
    <div id="wrapper">
        <?php include('../includes/leftbar.php'); ?>
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Users Feedback</h3>
...
$sql01 = "SELECT * FROM feedback WHERE reciver = :reciver ORDER BY id ASC";
$query01 = $dbh->prepare($sql01);
$query01->bindParam(':reciver', $reciver, PDO::PARAM_STR);
$query01->execute();
...
$sql = "SELECT * FROM feedback WHERE reciver = :reciver ORDER BY id ASC LIMIT :page_first_result, :results_per_page";
$query = $dbh->prepare($sql);
